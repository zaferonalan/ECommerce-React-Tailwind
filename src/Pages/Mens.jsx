...
const Mens = () => {
  ...
  const menProduct = allProduct.filter((product) => product.category === "men")
  return (
    <div className="md:mt-32 mt-20 max-w-7xl mx-auto">
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:pt-24 lg:max-w-7xl lg:px-8">
        <h2 className="text-2xl font-bold tracking-tighter text-gray-900 text-center md:text-start">Men's Collection</h2>
